...
public class IFSC_Getter
{
	...
	private static void downloadUsingStream(String urlStr, String file) throws Exception{
	    ...
	    while((count = bis.read(buffer,0,1024)) != -1)
	    {
	        ...
	        System.out.print("\r ************** "+file+" is downloading "+new String(new char[len%10+1]).replace("\0", ".")+" ************");
	    }
	    fis.close();
	    bis.close();
	    System.out.print("\r**************"+file+" downloaded************\n");
	}
	
	//delete downloaded files
	public static void delete_files(String name)
	{
		...
		{
			System.out.println(f.getName() + " deletion failed");
		}
	}
	...
	public static void main(String[] args) throws Exception
	{
	    ...
	    try {
	    	System.out.print("************** NEFT file is downloading ************");
	        downloadUsingStream(neft, neft_file_name);
	        System.out.print("************** RTGS file is downloading ************");
		...
		try {
			...
			delete_files(neft_file_name);
			delete_files(rtgs_file_name);
		}
		catch(Exception e)
		{
			e.printStackTrace();
